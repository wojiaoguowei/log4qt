 ...
 * Declarations
 ******************************************************************************/
#if defined(LOT4QT_LIBRARY)
#define LOT4QTSHARED_EXPORT Q_DECL_EXPORT
#else
#define LOT4QTSHARED_EXPORT Q_DECL_IMPORT
#endif
...
namespace Log4Qt
{
	 ...
	 */
	 class LOT4QTSHARED_EXPORT PatternLayout : public Layout
	{
		Q_OBJECT
